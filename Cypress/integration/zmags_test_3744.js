...
describe('ZmagsSmoke', function(){
  ...
  it('Open Creator', function () {
    ...
    cy.visit('http://development.eu.zmags.com/branches/MOS-3744-xp-viewer-lightbox/code/latest/', { timeout: 30000 })
  ...
  it('Log into Creator', function () {
    ...
    cy.get('input[type=text]')
      .type('janis.oteps@gmail.com', { delay: 100 }).should('have.value', 'janis.oteps@gmail.com')
